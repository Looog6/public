...
from exchange import ExchangeException, Exchange
...
def get_price(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise ExchangeException('Введите команду /help или 3 параметра')
